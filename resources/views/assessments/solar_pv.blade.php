...
@section('content')
    ...
    <div class="card">
        <div class="card-block">
            <form action="{{$assessment?url('assessments/solar-pv/'.$assessment->id):url('assessments/add')}}" method="post">
                <input type="hidden" name="product" value="solar-pv">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        {{ Form::bsText('electricity_spend','How much do you spend on you electricity?', $assessment?$assessment->electricity_spend:'') }}
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        {{ Form::bsSelect('property_roof_pitch','Is your roof, flat or pitched?', ['flat'=>'Flat', 'pitched'=>'Pitched'], $assessment?$assessment->property_roof_pitch:'') }}
                    </div>
                    <div class="col-md-6">
                        {{ Form::bsSelect('property_roof_underfelt','Does your roof have underfelt?', ['y'=>'Yes', 'n'=>'No'], $assessment?$assessment->property_roof_underfelt:'') }}
                    </div>
                    <div class="col-md-6">
                        {{ Form::bsText('property_roof_obstructions','Are there any obstructions on the roof?', $assessment?$assessment->property_roof_obstructions:'') }}
                    </div>
                    <div class="col-md-6">
                        {{ Form::bsText('property_roof_facing','Which way does the property face?', $assessment?$assessment->property_roof_facing:'') }}
                    </div>
                    <div class="col-md-6">
